...
flux create kustomization jupyterhub-sources --source="GitRepository/jupyterhub" --namespace=jupyterhub --path="./sources" --interval=1m --prune=true --health-check-timeout=10m --wait=false
```
